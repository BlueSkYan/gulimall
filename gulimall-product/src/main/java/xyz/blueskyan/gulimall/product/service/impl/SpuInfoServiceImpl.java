...
import xyz.blueskyan.common.to.es.SkuEsModel;
import xyz.blueskyan.common.utils.PageUtils;
import xyz.blueskyan.common.utils.Query;

import xyz.blueskyan.common.utils.R;
import xyz.blueskyan.gulimall.product.dao.SpuInfoDao;
import xyz.blueskyan.gulimall.product.entity.*;
import xyz.blueskyan.gulimall.product.feign.CouponFeignService;
import xyz.blueskyan.gulimall.product.feign.WareFeignService;
import xyz.blueskyan.gulimall.product.service.*;
import xyz.blueskyan.gulimall.product.vo.*;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        if (skus != null && skus.size() > 0) {
            skus.forEach(item -> {
                ...
                //5.4.sku的优惠、满减信息 gulimall_sms->sms_sku_ladder/sms_sku_full_reduction/
    ...
    public void up(Long spuId) {
        ...
        // TODO 5.将属性发给es进行保存：gulimall-search
    }
}